...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x4c, "JMP abs", 3, 3, AddressingMode::Absolute),
        OpCode::new(0x6c, "JMP ind", 3, 5, AddressingMode::Immediate),
        ...
        OpCode::new(0x40, "RIT", 1, 6, AddressingMode::NoneAddressing),
